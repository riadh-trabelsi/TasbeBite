    ...
    try {
      ...
      if (response.status === 201) {
        ...
        if (loginResponse.status === 201) {
          ...
          dispatch(getUser(loginResponse.data.token)).then((res) => {
            navigate("/");
          });
        }
      }
    ...
    <>
      <div className="relative flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <video
          ...
          src="https://cdn.pixabay.com/video/2020/03/05/33257-396487989_large.mp4"
          type="video/mp4"
        >
        ...
        <div className="mt-10 z-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form
            className="space-y-6 bg-white bg-opacity-80 p-6 rounded-md"
